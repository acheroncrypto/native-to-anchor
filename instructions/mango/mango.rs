    ...
    pub fn unpack(input: &[u8]) -> Option<Self> {
        ...
        Some(match discrim {
            ...
            15 => {
                ...
                MangoInstruction::ConsumeEvents {
            ...
            24 => {
                ...
                MangoInstruction::ForceCancelSpotOrders {
            ...
            39 => {
                let data_arr = array_ref![data, 0, 1];
                MangoInstruction::CancelAllPerpOrders {
                    limit: u8::from_le_bytes(*data_arr),
                }
            }
            ...
            63 => {
                ...
                MangoInstruction::RegisterReferrerId {
...
fn unpack_dex_new_order_v3(data: &[u8]) -> Option<serum_dex::instruction::NewOrderInstructionV3> {
    let max_ts = if data.len() == 54 {
        i64::from_le_bytes(*array_ref![data, 46, 8])
    } else {
        i64::MAX
    };
...
pub fn place_perp_order2(
    ...
    let mut accounts = vec![
        ...
        AccountMeta::new(*event_queue_pk, false),
        AccountMeta::new(
            *referrer_mango_account_pk.unwrap_or(mango_account_pk),
            false,
        ),
    ];
...
pub fn cancel_perp_order_by_client_id(
    ...
    let instr = MangoInstruction::CancelPerpOrderByClientId {
        client_order_id,
        invalid_id_ok,
    };
    let data = instr.pack();
...
pub fn cancel_perp_order(
    ...
    let instr = MangoInstruction::CancelPerpOrder {
        order_id,
        invalid_id_ok,
    };
    let data = instr.pack();
...
// Filler for Anchor IDL
pub fn force_cancel_spot_orders(program_id: &Pubkey) -> Result<Instruction, ProgramError> {
    let mut accounts = vec![
        AccountMeta::new_readonly(*mango_group_pk, false),
        AccountMeta::new_readonly(*mango_cache_pk, false),
    ...
    let instr = MangoInstruction::ForceCancelSpotOrders { limit };
    let data = instr.pack();
    Ok(Instruction {
        program_id: *program_id,
        accounts,
...
pub fn consume_events(
    ...
    mango_acc_pks.sort();
    let mango_accounts = mango_acc_pks
        .into_iter()
...
pub fn withdraw(
    ...
    let instr = MangoInstruction::Withdraw {
        quantity,
        allow_borrow,
    };
    let data = instr.pack();
...
pub fn liquidate_perp_market(
    ...
    let instr = MangoInstruction::LiquidatePerpMarket {
